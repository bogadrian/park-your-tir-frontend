...
export const setChangeEnabledSucces = user => ({
  type: userActionTypes.SET_CHANGE_ENBALED_SUCCESS,
  payload: user
});

export const changeEnabled = user => ({
  type: userActionTypes.SET_CHANGE_ENABLED_START,
  payload: user
});
